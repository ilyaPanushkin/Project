...
// 1. Спецсимволы в поле "LastName"

//Валидные символы в проверяемом поле
GlobalVariable.firstPartEnterSym = "Derek";
// Название поля в логах
GlobalVariable.fieldName = "LastName";
// Путь к обьекту поля в которое вводятся символы для проверки из массива в 36 строке
GlobalVariable.pathField  = "Page_JH - JH Tackle/input_Last Name_surname";
// Путь к ообьекту сообщения об ошибке для проверки
GlobalVariable.actualText = "Object Repository/Page_JH - JH Tackle/div_The surname may only contain letters";
// Ожидаемый текст с ошибкой
GlobalVariable.expectedText = "The surname may only contain letters.";
...
// Путь к обьекту сообщения об ошибке для проверки
 GlobalVariable.actualText = "Object Repository/Page_JH - JH Tackle/Page_JH - JH Tackle/div_The surname field is required";
// Ожидаемый текст с ошибкой
 GlobalVariable.expectedText = "The surname field is required.";
// Обьект который это все выполнит :)
...
// Массив с невалидными значениями
